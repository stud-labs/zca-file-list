...
ext_modules=[
#    Extension("zca-file-list.cython_module",
#              sources=["src/./zca-file-list/cython_module.pyx"],
#              libraries=["gdal"],
#    )
]
...
setup(
    name='zca-file-list',
    version=version,
    description="ZCA example project",
    ...
    #     """.split('\n') if c.strip()],
    # ],
    keywords='zca zope example',
    author='Evgeny Cherkashin',
    author_email='eugeneai@irnok.net',
    url='https://github.com/stud-labs/zca-file-list',
    license='GPLv3.0',
    ...
    entry_points={
        'console_scripts':
            ['zca-file-list=zcafilelist:main']
    },
